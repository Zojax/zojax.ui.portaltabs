...
menu.loadtreexml = function(url, node) {
    ...
    xmlHttp.onreadystatechange = function() {
        ...
        menu.parseXML(xmlHttp.responseXML, node);
    };
...
menu.loadtree = function(rooturl, thismenubaseurl) {
